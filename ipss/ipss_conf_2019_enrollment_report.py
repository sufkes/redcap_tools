...
#                print changes, username, dag
    ...
    exclusion_list = ["ipsstest1", "ipsstest2", "ipsstest3", "kathleen.colao@ucsf.edu", "Kathleen.Colao@ucsf.edu", "susan.dang", "hojun.lim", "daniel.ostromich", "michele.petrovic", "priyanka.shah", "philip.alexander", "justin.foong", "allyssa.johnston", "shun.cheung", "ashley.schipani", "kathryn.sievers", "anissa.mumin", "furqan.syed", "amanda.robertson", "michael.choi", 'justin.lee']
